...
#include <stdbool.h>
#include "FT6236.h"
#include <Wire.h>//Libraries to be added
#include <SPI.h>//Libraries to be added
#include <FS.h>//Libraries to be added
/*
...
void my_touchpad_read( lv_indev_drv_t * indev_driver, lv_indev_data_t * data )
{
  ...
  if (pos[0] > 0 && pos[1] > 0)
  {
    ...
    tft.fillCircle(touchX, touchY, 10, TFT_BLACK); // Draw a circle using positive coordinate values 
  }
  else {
