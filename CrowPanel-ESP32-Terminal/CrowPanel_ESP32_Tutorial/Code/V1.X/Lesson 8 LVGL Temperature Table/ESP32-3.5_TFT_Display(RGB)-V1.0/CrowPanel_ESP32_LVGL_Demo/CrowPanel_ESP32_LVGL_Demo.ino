...
/**************************************************************************************
* @file my_timer
* @brief Function to Refresh the screen display in real timece
...
void my_timer(lv_timer_t * timer)
{
    ...
    char *hum       = (char *)malloc(20);

      //Get ambient temperature
      sprintf(tem, "Temperature: %.2f C ", tem_float = dht.readTemperature());
      //Serial.print(tem);
      lv_label_set_text(ui_Label1, tem);

      //Get relative humidity
      sprintf(hum, "Humidity: %.2f %RH", hum_float = dht.readHumidity());
      //Serial.println(hum);
